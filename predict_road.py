...
# Get all images
im = mpimg.imread('/home/pi1/yolov9/data/images/road2.jpg')
...
vertices = np.array([[(0,imshape[0]),(imshape[1]*1/6,imshape[0]/4), (imshape[1]*5/6,imshape[0]/4), (imshape[1],imshape[0])]], dtype=np.int32)
...
linesAll = cv2.HoughLinesP(maskedIm, rho, theta, threshold, np.array([]),
...
cv2.imwrite('/home/pi1/yolov9/data/images/road3.jpg', finalMaskedIm)


fig, axes = plt.subplots(4,3, figsize=(13, 13))
images = [im, grayIm, smoothedIm, edgesIm, mask, maskedIm, allLines, laneLines, colorLines, blendedIm, finalMask, finalMaskedIm]
names = ['im', 'grayIm', 'smoothedIm', 'edgesIm', 'mask', 'maskedIm', 'allLines', 'laneLines', 'colorLines', 'blendedIm', 'finalMask', 'finalMaskedIm']
...
imShow('/home/pi1/yolov9/data/images/road3.jpg')
imShow('/home/pi1/yolov9/runs/detect/road/road3.jpg')